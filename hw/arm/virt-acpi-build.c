...
void virt_acpi_build(VirtMachineState *vms, AcpiBuildTables *tables)
{
    ...
    /*
     * Align the ACPI blob lengths to PAGE_ALIGN so that on ACPI
     * regeneration, the length that firmware sees really gets
     * updated by acpi_ram_update() -> qemu_ram_resize().
     */
